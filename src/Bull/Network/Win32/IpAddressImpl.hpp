#ifndef BULL_NETWORK_WIN32_IPADDRESSIMPL_HPP
#define BULL_NETWORK_WIN32_IPADDRESSIMPL_HPP
...
namespace Bull
{
    namespace prv
    {
        struct IpAddressImpl
        {
             ...
             *
             */
            static SockAddrLenght toSockAddr(const IpAddress& ip, NetPort port, void* buffer);
        };
    }
}

#endif // BULL_NETWORK_WIN32_IPADDRESSIMPL_HPP
