#ifndef BULL_NETWORK_UNIX_SOCKETIMPL_HPP
#define BULL_NETWORK_UNIX_SOCKETIMPL_HPP
...
namespace Bull
{
    namespace prv
    {
        ...
        public:
             ...
             *
             */
            static Index sendTo(SocketHandler handler, const IpAddress& to, NetPort port, const void* data, Index length);
...
#endif // BULL_NETWORK_UNIX_SOCKETIMPL_HPP
