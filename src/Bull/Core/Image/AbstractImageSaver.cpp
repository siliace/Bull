...
namespace Bull
{
    ...
    void AbstractImageSaver::saveToBmp(OutStream& stream, const Size& size, int channels, const ByteArray& pixels) const
    {
    ...
    void AbstractImageSaver::saveToTga(OutStream& stream, const Size& size, int channels, const ByteArray& pixels) const
    {
    ...
    void AbstractImageSaver::saveToPng(OutStream& stream, const Size& size, int channels, const ByteArray& pixels, int stride) const
    {
    ...
    void AbstractImageSaver::saveToJpg(OutStream& stream, const Size& size, int channels, const ByteArray& pixels, int quality) const
    {
