...
namespace Bull
{
    namespace prv
    {
        ...
        unsigned int JoystickImpl::getAxisPosition(JoystickAxis axis, Uint8 joystick)
        {
            ...
            {
                case JoystickAxis_X:
                    return joystickState.dwXpos;
                case JoystickAxis_Y:
                    return joystickState.dwYpos;
                case JoystickAxis_Z:
                    return joystickState.dwZpos;
                case JoystickAxis_R:
                    return joystickState.dwRpos;
                case JoystickAxis_U:
                    return joystickState.dwUpos;
                case JoystickAxis_V:
                    return joystickState.dwVpos;
                case JoystickAxis_PovX:
                    return joystickState.dwPOV;
                case JoystickAxis_PovY:
                    return joystickState.dwPOV;
            }
