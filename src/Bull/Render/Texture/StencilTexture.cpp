...
namespace Bull
{
    ...
    void StencilTexture::create(const Size<std::size_t>& size)
    {
        ...
        {
            case StencilValue_1:
                Texture::create(size, PixelFormat_Stencil1);
                break;
            case StencilValue_4:
                Texture::create(size, PixelFormat_Stencil4);
                break;
            case StencilValue_8:
                Texture::create(size, PixelFormat_Stencil8);
                break;
            case StencilValue_16:
                Texture::create(size, PixelFormat_Stencil16);
                break;
        }
    }
