...
namespace Bull
{
    namespace prv
    {
        ...
        public:
             ...
             *
             */
            WglContext(const std::shared_ptr<WglContext>& shared, const ImplPtr<WindowImpl>& window, Uint8 bitsPerPixel, const ContextSettings& settings);
        ...
        private:
             ...
             *
             */
            void createSurface(const ImplPtr<WindowImpl>& window);
