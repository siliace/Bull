...
namespace Bull
{
    namespace prv
    {
        std::set<std::string> ExtensionsLoader::getAllExtensions(SurfaceHandler surface)
        {
            int extensionsCount;
            ...
            {
                extensions.insert(std::string(reinterpret_cast<const char*>(gl::getStringi(GL_EXTENSIONS, static_cast<unsigned int>(i)))));
            }

            std::vector<std::string> tokens = ExtensionsLoaderType::getExtensions(surface);
        ...
        void ExtensionsLoader::loadExtensions(SurfaceHandler surface)
        {
            ...
            for(const std::string& extension : m_allExtensions)
            {
        ...
        bool ExtensionsLoader::isSupported(const std::string& extension) const
        {
